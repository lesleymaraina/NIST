...
df.to_csv('DEL.tSNE_minSample_0.csv', index=False)
...
df.to_csv('DEL.tSNE.SVD_minSample_0.csv', index=False)
...
df.to_csv('DEL.tSNE.raw_minSample_0.csv', index=False)

# Store DBSCAN minSample results in new dataframes
minSample0 = pd.read_csv('/Volumes/lesleydata/SVVIZOutput/April112017/Step4/MachineLearning/Step3.tSNE/DEL.tSNE_minSample_0.csv')
minSample5 = pd.read_csv('/Volumes/lesleydata/SVVIZOutput/April112017/Step4/MachineLearning/Step3.tSNE/DEL.tSNE_minSample_5.csv')
minSample10 = pd.read_csv('/Volumes/lesleydata/SVVIZOutput/April112017/Step4/MachineLearning/Step3.tSNE/DEL.tSNE_minSample_10.csv')
minSample15 = pd.read_csv('/Volumes/lesleydata/SVVIZOutput/April112017/Step4/MachineLearning/Step3.tSNE/DEL.tSNE_minSample_15.csv')
minSample20 = pd.read_csv('/Volumes/lesleydata/SVVIZOutput/April112017/Step4/MachineLearning/Step3.tSNE/DEL.tSNE_minSample_20.csv')
minSample25 = pd.read_csv('/Volumes/lesleydata/SVVIZOutput/April112017/Step4/MachineLearning/Step3.tSNE/DEL.tSNE_minSample_25.csv')
...
#Size Bins
bins = [20,50,100,1000,3000,10000,168102]
df4['Size'] = df4['Size'].abs()
group_names_size = ['20-50', '50-100', '100-1000', '1000-3000', '3000-10000', '10000-168102']
...
dftsne['minSample0'] = minSample0['clusterLabel']
dftsne['minSample5'] = minSample5['clusterLabel']
dftsne['minSample10'] = minSample10['clusterLabel']
dftsne['minSample15'] = minSample15['clusterLabel']
dftsne['minSample20'] = minSample20['clusterLabel']
dftsne['minSample25'] = minSample25['clusterLabel']


dftsne.to_csv('dftsne_minSamp.csv', index=False)

dftsne2 = pd.DataFrame()
df['x'] = dftsne['x']
df['y'] = dftsne['y']
dftsne2['Size2'] = df4['Size2']
dftsne2['Size'] = df4['Size']
dftsne2['GTcons'] = df4['GTcons']
dftsne2['sample'] = df4['sample']
dftsne2['refN_pct'] = df4['refN_pct']
dftsne2['label'] = df['clusterLabel']
dftsne2['label.SVD'] = df['clusterLabel.SVD']
dftsne2['label.raw'] = df['clusterLabel.raw']
dftsne2['x'] = df['x']
dftsne2['y'] = df['y']

dftsne2.to_csv('dftsne_minSamp2.csv', index=False)

'''
Generate plots
'''

p = Scatter(dftsne, x='x', y='y', title='HG002 DEL: tSNE')
output_file("tSNE1_DEL.html")
show(p)
...
p = Scatter(dftsne, x='x', y='y', color='minSample5', title='HG002 DEL: DBSCAN minSample5', legend="top_left")
output_file("tSNE3_DEL_minSamp10.html")
show(p)

p = Scatter(dftsne, x='x', y='y', color='minSample10', title='HG002 DEL: DBSCAN minSample10', legend="top_left")
output_file("tSNE3_DEL_minSamp10.html")
show(p)

p = Scatter(dftsne, x='x', y='y', color='minSample15', title='HG002 DEL: DBSCAN minSample15', legend="top_left")
output_file("tSNE3_DEL_minSamp15.html")
show(p)

p = Scatter(dftsne, x='x', y='y', color='minSample20', title='HG002 DEL: DBSCAN minSample20', legend="top_left")
output_file("tSNE3_DEL_minSamp20.html")
show(p)

p = Scatter(dftsne, x='x', y='y', color='minSample25', title='HG002 DEL: DBSCAN minSample25', legend="top_left")
output_file("tSNE3_DEL_minSamp25.html")
show(p)
...
# p = Scatter(dftsne, x='x', y='y', fill_color = colors, title='HG002 DEL: tSNE segmental duplications', legend="top_left")
# output_file("tSNE3_DEL_segDup.html")
# show(p)

p = Histogram(log_size, values='DEL_log_size', title='HG002 DEL: Size Distribution [5000 Samples]', color='LightSlateGray', bins=40, xlabel="Size[log10]", ylabel="Frequency")
...
p = Scatter(dftsne, x='x', y='y', color='refN_pct', title='HG002 DEL: Reference N', legend="top_left")
output_file("tSNE7_DEL_RefN.html")
show(p)
