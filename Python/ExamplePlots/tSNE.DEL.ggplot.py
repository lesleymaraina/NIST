...
# About
# Resources
# https://github.com/glamp/ggplot-tutorial/tree/master/notebooks
# https://www.youtube.com/watch?v=pHrwqLhAaMw
# http://www.datacarpentry.org/python-ecology-lesson/06-visualization-ggplot-python/
# FYI: Matplotlib D3
# https://www.youtube.com/watch?v=h3EnqnhATQ0
###########################################
...
'''
ALERT: Cannot get rid of grey ggplot background
'''
