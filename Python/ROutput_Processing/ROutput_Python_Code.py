...
train = pd.read_csv('Users/lmc2/Desktop/NIHFAES/FinalProject/Train/ROutput/TSVDataframes/MPtest.DEL.csv')
df = pd.DataFrame(train)
# print df.head(5)

# Will select all deletions from this dataframe
trainDel = pd.read_csv('Users/lmc2/Desktop/NIHFAES/FinalProject/Train/ROutput/TSVDataframes/MPtest.DEL.csv')
...
print SV_count3
new_df.to_csv('Users/lmc2/Desktop/NIHFAES/FinalProject/Train/ROutput/TSVDataframes/PacBio.INS.csv', index=False)
