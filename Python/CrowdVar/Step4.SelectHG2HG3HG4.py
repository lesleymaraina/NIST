...
train_DEL = pd.read_csv('/Users/lmc2/Desktop/NIHFAES/FinalProject/Train/CrowdVar.Train.csv')
...
df_DEL_HG002.to_csv('/Users/lmc2/Desktop/NIHFAES/FinalProject/Train/CrowdVar.Train_HG002.csv', index=False)

# Select HG003 Rows
df_DEL_HG003 = df_DEL[df_DEL['sample'].str.contains("HG003")]
print df_DEL_HG003.tail(8)
df_DEL_HG003.to_csv('/Users/lmc2/Desktop/NIHFAES/FinalProject/Train/CrowdVar.Train_HG003.csv', index=False)

# Select HG004 Rows
df_DEL_HG004 = df_DEL[df_DEL['sample'].str.contains("HG004")]
print df_DEL_HG004.tail(8)
df_DEL_HG004.to_csv('/Users/lmc2/Desktop/NIHFAES/FinalProject/Train/CrowdVar.Train_HG004.csv', index=False)
